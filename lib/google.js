...
const { cors, asyncJsonHandler, isCacheError, localize } = require('./handlers')
...
module.exports = Router()
  ...
  .use('/:sheetId', localize(req => req.params))
  .use('/:sheetId@:version', localize(req => req.params))
  .use(
    cors,
    cache({
  ...
  .get('*', asyncJsonHandler((req, res) => getTranslations(res.locals)))
